...
class TestField(UAVObjectField):
    def __init__(self):
    	UAVObjectField.__init__(self, 6, 1)



# Object FlightPlanSettings definition
class FlightPlanSettings(UAVObject):
    # Object constants
    OBJID = -1830158474

    # Constructor
    def __init__(self):
        UAVObject.__init__(self, FlightPlanSettings.OBJID)

        # Create object fields
    	self.Test = TestField()
    	self.addField(self.Test)
