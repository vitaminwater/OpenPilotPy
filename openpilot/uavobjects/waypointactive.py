...
class IndexField(UAVObjectField):
    def __init__(self):
        UAVObjectField.__init__(self, 1, 1)



# Object WaypointActive definition
class WaypointActive(UAVObject):
    # Object constants
    OBJID = 514175388

    # Constructor
    def __init__(self):
        UAVObject.__init__(self, WaypointActive.OBJID)

        # Create object fields
        self.Index = IndexField()
        self.addField(self.Index)
