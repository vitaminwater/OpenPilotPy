...
##############################################################################
#
# @file       stabilizationsettingsbank2.py
...
# Object StabilizationSettingsBank2 definition
class StabilizationSettingsBank2(UAVObject):
    # Object constants
    OBJID = 1894339482

    # Constructor
    def __init__(self):
        UAVObject.__init__(self, StabilizationSettingsBank2.OBJID)
