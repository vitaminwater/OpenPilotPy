...
##############################################################################
#
# @file       stabilizationsettingsbank3.py
...
# Object StabilizationSettingsBank3 definition
class StabilizationSettingsBank3(UAVObject):
    # Object constants
    OBJID = -1070749078

    # Constructor
    def __init__(self):
        UAVObject.__init__(self, StabilizationSettingsBank3.OBJID)
